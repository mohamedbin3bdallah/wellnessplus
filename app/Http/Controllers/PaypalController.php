    ...
    {	
		...
		$transaction = new Transaction();
		        $transaction->setAmount($amount)
		            ...
		            ->setDescription(__('backend.your_transaction_description'));
		...
		\Session::put('error', __('backend.connection_timeout'));
		                return Redirect::route('paywithpaypal');
		} else {
		\Session::put('error', __('backend.some_error_occur_sorry_for_inconvenient'));
		                return Redirect::route('paywithpaypal');
		}
		}
		...
		\Session::put('error', __('backend.error'));
		        return Redirect::route('paywithpaypal');
	}
	...
	public function getPaymentStatus(Request $request)
    {
		...
		/** clear the session payment ID **/
		        ...
		        if (empty($request->get('PayerID')) || empty($request->get('token')))
		         ...
		         {
		\Session::put('error', __('backend.payment_failed'));
