...
class AdsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'ad_hold' => 'int'
          ...
          'ad.hold' => __('backend.ad_hold_time_must_be_in_valid_format')
        ]);
		  $name = time().$file->getClientOriginalName();
      ...
      if ($file = $request->file('ad_image'))
         {
          ...
          return redirect()->route('ads')->with('success',__('backend.updated_successfully'));
    ...
    public function bulk_delete(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return back()->with('delete', __('backend.please_select_one_of_them_to_delete'));
        }
