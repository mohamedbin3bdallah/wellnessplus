...
class AdsenseController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if(isset($ad))
        {
          ...
          if($ad->status = 'on')
          {
            return redirect()->route('adsense')->with('updated',__('backend.record_is_now_active'));
            
          }
          else 
          {
            return redirect()->route('adsense')->with('updated',__('backend.record_is_now_deactive'));
