...
class BundleCourseController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if(!$order->isEmpty())
        {
          return back()->with('delete',__('backend.users_are_enrolled_in_course'));
        }
        else{
    ...
    public function addtocart(Request $request, $id)
    {
        ...
        return back()->with('success',__('backend.course_is_added_to_your_cart'));
    ...
    public function enroll(Request $request, $id)
    {
        ...
        return back()->with('success',__('backend.you_are_successfully_enrolled_in_a_course'));
    }
}
