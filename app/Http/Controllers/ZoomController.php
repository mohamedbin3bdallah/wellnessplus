...
class ZoomController extends Controller
{
    public function dashboard(Request $request){
      if(Auth::user()->role == 'admin' || Auth::user()->role == 'instructor'){
        ...
        if ($err) {
          ...
          return redirect()->route('zoom.setting')->with('delete',__('backend.zoom_token_or_email_not_found'));
        }
      }else{
    ...
    public function updateToken(Request $request){
      ...
      if($query){
        return redirect()->route('zoom.index')->with('success',__('backend.updated_successfully'));
      }else{
        return back()->with('deleted',__('backend.update_failed'));
      }
    }
    ...
    if($response == ''){
      ...
      return redirect()->route('zoom.index')->with('success',__('backend.deleted_successfully'));
    }else{
      ...
      $request->validate([
        ...
        $token = Auth::user()->jwt_token;
         ...
         $curl = curl_init();
          ...
          return redirect()->route('zoom.show',$response['id'])->with('success',__('backend.created_successfully'));
    }
