                            ...
                            <ul class="listserv">
                                <li>
                                    <p>
                                        ...
                                        @else
                                        1 {{ __('frontend.hours') }} {{ __('frontend.lesson') }}
                                        @endif
                                    </p>

                                    <span>{{$currency_code}} {{$cartRecord->offer_price}}</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span>{{$currency_code}} {{ $cartRecord->offer_price - $cartRecord->disamount }}</span>
                                </li>
                            </ul>
                        </div>
                        <div class="childbox total-det">
                            <h3 class="price-tp">{{ __('frontend.tootal') }}
                                <span>{{$currency_code}} {{ ($cartRecord->offer_price - $cartRecord->disamount ) + $transaction_fees }}</span>
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 contenuser mt-0">
                        ...
                        <form method="post" action="/rave/callback/free">
                            <div class="text-center">
                                ...
                                <input type="hidden" name="description" value="client Pay for Tutor Hours" /> <!-- Replace the value with your transaction description -->
                        ...
                        <div class="text-center">
                            ...
                            @if($cartRecord->offer_price - $cartRecord->disamount < $cartRecord->offer_price)
                                ...
                                <form method="post" action="/paywithrave">
                                    ...
                                    <button class="bottom" type="submit">{{ __('frontend.continue_booking') }}</button>
                                </form>
    ...
    (function($) {
        ...
        function makePayment() {
            FlutterwaveCheckout({
                ...
                country: "US",
                payment_options: " ",
                redirect_url: "https://www.wellness.live/payment/frontend",
                meta: {
                    consumer_id: "{{$user->id}}",
                ...
                callback: function(data) {
                    ...
                    if (status === "successful") {
                        window.location.href = `https://www.wellness.live/payment/frontend?status=${status}`;
                    }
                },
                onclose: function() {
                    // close modal
