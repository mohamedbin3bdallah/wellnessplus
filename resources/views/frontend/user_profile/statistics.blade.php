...
@include('frontend.layouts.pages.tutor', ['page' => 'Statistics'])

<section class="statistics">
    <div class="container">
        <div class="item-sta">
            <div class="headtitle">
                <h2 class="title">{{ __('frontend.profile_attractiveness') }}</h2>
                ...
                <div class="col-sm-4 inner-sta">
                    <div class="in-item">
                        ...
                        <div class="content">
                            ...
                            <p class="text">{{ __('frontend.reviews_received') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.reviews_received_text') }}</small></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 inner-sta">
                    <div class="in-item">
                        ...
                        <div class="content">
                            ...
                            <p class="text">{{ __('frontend.average_rating') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.average_rating_text') }}</small></span></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="item-sta">
            <div class="headtitle flex">
                <h2 class="title">{{ __('frontend.profile_activities') }}</h2>
                {{-- <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="all-time-tab" data-toggle="tab" href="#all-time" role="tab" aria-controls="all-time" aria-selected="true">{{ __('frontend.all_time') }}</a></li>
                    <li class="nav-item"><a class="nav-link" id="month-tab" data-toggle="tab" href="#month" role="tab" aria-controls="month" aria-selected="false">{{ __('frontend.month') }}</a></li>
                    <li class="nav-item"><a class="nav-link" id="week-tab" data-toggle="tab" href="#week" role="tab" aria-controls="week" aria-selected="false">{{ __('frontend.week') }}</a></li>
                </ul> --}}
            </div>
                        ...
                        <div class="col-sm-4 inner-sta">
                            <div class="in-item">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text">{{ __('frontend.unique_profile_view') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.unique_profile_view_text') }}</small></span></p>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="col-sm-4 inner-sta">
                            <div class="in-item">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text">{{ __('frontend.average_response_time') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.average_response_time_text') }}</small></span></p>
                                </div>
                            </div>
                        </div> --}}
                        {{-- <div class="col-sm-4 inner-sta">
                            <div class="in-item">
                                ...
                                <div class="content">
                                    <h4 class="title">0%</h4>
                                    <p class="text">{{ __('frontend.conversion_to_package') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.conversion_to_package_text') }}</small></span></p>
                                </div>
                            </div>
                        </div> --}}
                    </div>
        ...
        <div class="item-sta">
            <div class="headtitle flex">
                <h2 class="title">{{ __('frontend.overall_activity') }}</h2>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="all-time2-tab" data-toggle="tab" href="#all-time2" role="tab" aria-controls="all-time2" aria-selected="true">{{ __('frontend.all_time') }}</a></li>
                    <li class="nav-item"><a class="nav-link" id="month2-tab" data-toggle="tab" href="#month2" role="tab" aria-controls="month2" aria-selected="false">{{ __('frontend.month') }}</a></li>
                    <li class="nav-item"><a class="nav-link" id="week2-tab" data-toggle="tab" href="#week2" role="tab" aria-controls="week2" aria-selected="false">{{ __('frontend.week') }}</a></li>
                </ul>
            </div>
            <div class="tab-content" id="myTabContent">
                        ...
                        <div class="col-sm-4 inner-sta">
                            <div class="in-item">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text">{{ __('frontend.total_tutoring_hours') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.total_tutoring_hours_text') }}</small></span></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 inner-sta">
                            <div class="in-item">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text">{{ __('frontend.income_earned') }}<span class="fas fa-question tooltiptext"><small>{{ __('frontend.income_earned_text') }}</small></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
