...
@section('title', __('adminstaticword.View').' '.__('adminstaticword.Order'))
@section('body')
      	...
      	<div class="box box-primary">
              ...
              <div class="view-order">
                      ...
                      <b>
                        ...
                        @if($show->proof != NULL)
                           <a href="{{ asset('images/order/'.$show->proof) }}" download="{{$show->proof}}" title="Course">{{ __('adminstaticword.Download') }} <i class="fa fa-download"></i></a></br>
                        @endif
                        <br>
              ...
              @endif
  					...
  					<input type="button" class="btn btn-primary"  onclick="printDiv('printableArea')" value="{{ __('adminstaticword.Save') }}" />
