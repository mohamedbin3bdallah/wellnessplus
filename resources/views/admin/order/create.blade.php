...
@section('title', __('dashboard.enroll').' '.__('dashboard.student'))
@section('body')
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> {{ __('dashboard.enroll').' '.__('dashboard.student') }}</h3>
        </div>
        <div class="box-body">
          <div class="form-group">
            <form id="demo-form2" method="post" action="{{route('order.store')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <label>{{ __('dashboard.student') }}<span class="redstar">*</span></label>
                ...
                <div class="col-md-6">
                  <label>{{ __('dashboard.course') }}<span class="redstar">*</span></label>
              ...
              <div class="box-footer">
                <button type="submit" value="Add Slider" class="btn btn-md col-md-2 btn-primary">{{ __('dashboard.enroll').' '.__('dashboard.student') }}</button>
              </div>
