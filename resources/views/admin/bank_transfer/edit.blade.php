...
@section('title', __('adminstaticword.BankDetails'))
@section('body')
						...
						<br>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ $show['account_holder_name'] }}" name="account_holder_name" type="text" class="form-control" placeholder="{{ __('adminstaticword.AccountHolderName') }}" required autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ $show['bank_name'] }}" name="bank_name" type="text" class="form-control" placeholder="{{ __('adminstaticword.BankName') }}" required autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ $show['account_number'] }}" name="account_number" type="text" class="form-control" placeholder="{{ __('adminstaticword.AccountNumber') }}" required autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ $show['ifcs_code'] }}" name="ifcs_code" type="text" class="form-control" placeholder="{{ __('adminstaticword.IFCSCode') }}" autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ $show['swift_code'] }}" name="swift_code" type="text" class="form-control" placeholder="{{ __('adminstaticword.SwiftCode') }}" autocomplete="off"/>
			                </div>
		                  </div>
