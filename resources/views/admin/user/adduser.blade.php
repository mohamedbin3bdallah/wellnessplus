...
@section('body')
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.User'))
          ...
          <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6 col-6">
                ...
                <input value="{{ old('fname') }}" autofocus required name="fname" type="text" class="form-control" placeholder="{{ __('adminstaticword.FirstName') }}"/>
              </div>
              <div class="col-md-6 col-6">
                <label for="lname">
                  {{ __('adminstaticword.LastName') }}:<sup class="redstar">*</sup>
                </label>
                <input value="{{ old('lname')}}" required name="lname" type="text" class="form-control" placeholder="{{ __('adminstaticword.LastName') }}"/>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-6">
                 <label for="mobile">{{ __('adminstaticword.Email') }}: <sup class="redstar">*</sup></label>
                  <input value="{{ old('email')}}" required type="email" name="email" placeholder="{{ __('adminstaticword.Email') }}" class="form-control">
              </div>
              <div class="col-md-6">
                <label for="mobile">{{ __('adminstaticword.Mobile') }}: <sup class="redstar">*</sup></label>
                <input value="{{ old('mobile')}}" required type="text" name="mobile" placeholder="{{ __('adminstaticword.Mobile') }}" class="form-control">
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <textarea name="address" rows="1"  class="form-control" placeholder="{{ __('adminstaticword.Address') }}"></textarea>
              </div>
              <div class="col-md-6">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" value="{{ old('dob')}}" name="dob" required class="form-control pull-right" id="dob" placeholder="{{ __('adminstaticword.DateofBirth') }}">
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input required type="password" name="password" placeholder="{{ __('adminstaticword.Password') }}" class="form-control">
              </div>
            </div>
            <br>
...
{{--                <input value="{{ old('pin_code')}}" placeholder="{{ __('adminstaticword.Pincode') }}" type="text" name="pin_code" class="form-control">--}}
{{--              </div>--}}
            </div>
            <br>
...
{{--              </div>--}}
              <div class="col-md-3 display-none" id="doaboxxx">
                <label for="dob">{{ __('adminstaticword.DateofAnniversary') }}: <sup class="redstar">*</sup></label>
                  <input value="{{ old('doa')}}" name="doa" id="doa" type="text" class="form-control" placeholder="{{ __('adminstaticword.DateofAnniversary') }}">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <textarea id="detail" name="detail" rows="3"  class="form-control" placeholder="{{ __('adminstaticword.Detail') }}"></textarea>
              </div>
            </div>
            <br>
            <br>
...
{{--                </label>--}}
{{--                <input autofocus name="fb_url" type="text" class="form-control" placeholder="{{ __('adminstaticword.FacebookUrl') }}"/>--}}
{{--              </div>--}}
{{--              <div class="col-md-6">--}}
{{--                <label for="youtube_url">--}}
{{--                {{ __('adminstaticword.YoutubeUrl') }}:--}}
{{--                </label>--}}
{{--                <input autofocus name="youtube_url" type="text" class="form-control" placeholder="{{ __('adminstaticword.YoutubeUrl') }}"/>--}}
{{--                <br>--}}
{{--              </div>--}}
{{--            --}}
{{--              <div class="col-md-6">--}}
...
{{--                </label>--}}
{{--                <input autofocus name="twitter_url" type="text" class="form-control" placeholder="{{ __('adminstaticword.TwitterUrl') }}"/>--}}
{{--              </div>--}}
{{--              <div class="col-md-6">--}}
{{--                <label for="linkedin_url">--}}
{{--                {{ __('adminstaticword.LinkedInUrl') }}:--}}
{{--                </label>--}}
{{--                <input autofocus name="linkedin_url" type="text" class="form-control" placeholder="{{ __('adminstaticword.LinkedInUrl') }}"/>--}}
{{--              </div>--}}
{{--            </div>--}}
            <br>
            <br>
