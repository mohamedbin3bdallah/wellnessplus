...
@section('title', __('dashboard.view').' '.__('dashboard.assignment'))
@section('body')
  ...
  <div class="row">
    <div class="col-md-12">
    	<div class="box box-primary">
          	...
          	<h3 class="box-title">{{ __('dashboard.view').' '.__('dashboard.assignment') }}</h3>
       		</div>
              ...
              <form action="{{route('assignment.update',$assign->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row" style="{{ $assign['type'] == '1' ? '' : 'display:none' }}" id="sec1_one">
                    <div class="col-md-12">
                      <label for="exampleInputDetails">{{ __('dashboard.give_scores_to_assignment', ['num1'=>1, 'num2'=>10]) }}:</label>
                      <input min="1" max="10" class="form-control" name="rating" type="number" id="rating" value="{{ $assign->rating }}" placeholder="{{ __('dashboard.give_scores_to_assignment', ['num1'=>1, 'num2'=>10]) }}">
                    </div>
                  </div>
                  <br>
