              ...
              <form id="demo-form2" method="post" action="{{url('admin/quiztopic/')}}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="text" placeholder="{{ __('adminstaticword.QuizTopic') }}" class="form-control " name="title" id="exampleInputTitle" value="">
                  </div>
                </div>
                <br>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <textarea name="description" rows="3" class="form-control" placeholder="{{ __('adminstaticword.QuizDescription') }}"></textarea>
                  </div>
                </div>
                <br>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="number" placeholder="{{ __('adminstaticword.Marks') }}" class="form-control " name="per_q_mark" id="exampleInputTitle" value="">
                  </div>
                </div>
                <br>
                ...
                <div class="row display-none">
                  <div class="col-md-12">
                    ...
                    <input type="text" placeholder="{{ __('adminstaticword.QuizTimer') }}" class="form-control" name="timer" id="exampleInputTitle" value="1">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="text" placeholder="{{ __('adminstaticword.Days') }}" class="form-control" name="due_days" id="exampleInputTitle" >
                  </div>
                </div>
                <br>
