           ...
           <form id="demo-form2" method="POST" action="{{route('quiztopic.update', $topic->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <input type="text" placeholder="{{ __('adminstaticword.QuizTopic') }}" class="form-control " name="title" id="exampleInputTitle" value="{{ $topic->title }}">
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <textarea name="description" rows="3" class="form-control" placeholder="{{ __('adminstaticword.QuizDescription') }}">{{ $topic->description }}</textarea>
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <input type="number" placeholder="{{ __('adminstaticword.PerQuestionMarks') }}" class="form-control " name="per_q_mark" id="exampleInputTitle" value="{{ $topic->per_q_mark }}">
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row display-none">
                        <div class="col-md-12">
                          ...
                          <input type="text" placeholder="{{ __('adminstaticword.QuizTimer') }}" class="form-control" name="timer" id="exampleInputTitle" value="{{ $topic->timer }}">
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <small>{{ __('dashboard.days_after_quiz_will_start_when_user_enroll_in_course') }}</small>
                          <input type="text" placeholder="{{ __('adminstaticword.Days') }}" class="form-control" name="due_days" id="exampleInputTitle" value="{{ $topic->due_days }}">
                        </div>
                      </div>
                      <br>
