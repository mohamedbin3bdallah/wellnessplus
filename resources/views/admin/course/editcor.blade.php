              ...
              <div class="row">
                <div class="col-md-3 display-none">
                  ...
                  <div @if($cor->day =="" && $cor->day =="") class="display-none" @endif id="jeet">
                    ...
                    <input type="number" min="1"  class="form-control" name="day" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Days') }}" value="{{ $cor->day }}">
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <div @if($cor->price =="" && $cor->price =="") class="display-none" @endif id="doabox">
                    ...
                    <input type="number" step="0.01"   class="form-control" name="price" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Price') }}" value="{{ $cor->price }}">
                  </div>
                  ...
                  <br>
                    ...
                    <input type="number" step="0.01"  class="form-control" name="discount_price" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.DiscountPrice') }}" value="{{ $cor->discount_price }}">
                  </div>
                </div>
                <div class="col-md-3"> 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div @if($cor->preview_type =="video") class="display-none" @endif id="document2">
                    ...
                    <input  class="form-control" placeholder="{{ __('adminstaticword.URL') }}" name="url" id="url" value="{{ $cor->url }}">
                  </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  <label for="exampleInputSlug">{{ __('dashboard.course_expire_duration') }}</label>
                  <p class="inline info"> - {{ __('dashboard.enter_duration_in_month') }}</p>
                  <input min="1" class="form-control" name="duration" type="number" id="duration" value="{{ $cor->duration }}" placeholder="{{ __('dashboard.enter_duration_in_month') }}">
                </div>
              </div>
              <br>
              <br>
