            ...
            <form enctype="multipart/form-data" id="demo-form" method="post" action="{{url('courseclass/'.$cate->id)}}"data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea name="detail" rows="5"  class="form-control" placeholder="{{ __('adminstaticword.Detail') }}">{{ $cate->detail }}</textarea>
                </div>
              </div>
              <br>
              ...
              @if($cate->type =="video")
                ...
                <div class="row">
                  <div  class="col-md-12" id="duration">
                    ...
                    <input type="text" name="duration" value="{{ $cate->duration }}" class="form-control" placeholder="{{ __('adminstaticword.Duration') }}">
                  </div>
                </div>
                <br>
              @endif
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div @if($cate->preview_type =="video") class="display-none" @endif id="document22">
                    ...
                    <input  class="form-control" placeholder="{{ __('adminstaticword.URL') }}" name="preview_url" id="url" value="{{ $cate->preview_url }}">
                  </div>
                </div>
              </div>
              <br>
