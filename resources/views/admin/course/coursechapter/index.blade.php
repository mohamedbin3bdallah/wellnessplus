              ...
              <form id="demo-form2" method="post" action="{{ route('coursechapter.store') }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="text" placeholder="{{ __('adminstaticword.ChapterName') }}" class="form-control " name="chapter_name" id="exampleInputTitle" value="">
                  </div>
                  <div class="col-md-6"> 
                ...
                <div class="row"> 
                  <div class="col-md-6">
                      ...
                      <label for="exampleInputDetails">{{ __('adminstaticword.LearningMaterial') }}</label> - <p class="inline info">{{ __('dashboard.eg_zip_or_pdf_files') }}</p>
                      <br>
