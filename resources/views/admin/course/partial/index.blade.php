                      ...
                      <tr>
                        ...
                        <td>
                          <form  method="post" action="{{url('course/'.$cat->id)}}
                            ...
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                            <button onclick="return confirm('{{ __('dashboard.delete_message_alert') }}')"  type="submit" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash-o"></i></button>
                          </form>
                        </td>
                      </tr>
                    @endforeach
                      ...
                      <tr>
                        ...
                        <td>
                          <form method="post" action="{{url('course/'.$cor->id)}}
                            ...
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                            <button onclick="return confirm('{{ __('dashboard.delete_message_alert') }}')"  type="submit" class="btn btn-danger"><i class="fa fa-fw fa-trash-o"></i></button>
                          </form>
                        </td>
                      </tr>
                    @endforeach
