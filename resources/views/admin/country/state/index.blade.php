...
@section('title', __('dashboard.states'))
@section("body")
	  ...
	  <div class="col-xs-12">
	    <div class="box box-primary" >
	      <div class="box-header with-border">
	        <h3 class="box-title">{{ __('dashboard.states') }}</h3>
            ...
            <form id="demo-form2" method="post" action="{{route('state.manual')}}" data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}
				...
				<div class="row">
	                ...
	                <input type="text" name="name" class="form-control" placeholder="{{ __('adminstaticword.State') }}">
                  </div>
            	</div>
