...
@section('title', {{ __('adminstaticword.InstructorSettings'))
@section('body')
	          	...
	          	<div class="panel-body">
	          		<form action="{{ route('instructor.update') }}" method="POST">
		                ...
		                <div class="row">
							...
							<div class="col-md-12">
								<label for="Revenue">{{ __('dashboard.instructor').' '.__('dashboard.revenue') }}:</label>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<label for="Revenue">{{ __('dashboard.admin').' '.__('dashboard.revenue') }}:</label>
								<div class="input-group">
