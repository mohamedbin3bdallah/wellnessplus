<form enctype="multipart/form-data" method="POST" action="{{ route('setting.store') }}">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="exampleInputDetails">{{ __('adminstaticword.Logo') }}</label>- <p class="inline info">{{ __('dashboard.size_dimensions', ['int1'=>300, 'int2'=>90]) }}</p>
						<br>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label for="project_title">{{ __('adminstaticword.ProjectTitle') }}:<sup class="redstar">*</sup></label>
			  	<input value="{{ $setting->project_title }}" placeholder="{{ __('adminstaticword.ProjectTitle') }}" name="project_title" type="text" class="{{ $errors->has('project_title') ? ' is-invalid' : '' }} form-control">
		...
		<div class="col-md-6">
			<div class="row">
                ...
                @endif
				<div class="col-md-6">
					<label for="exampleInputDetails">{{ __('adminstaticword.Favicon') }}</label>- <p class="inline info">{{ __('dashboard.size_dimensions', ['int1'=>35, 'int2'=>35]) }}</p>
					<br>
	...
	<div class="row">
		<div class="col-md-6">
			<label for="APP_URL">{{ __('adminstaticword.APPURL') }}:<sup class="redstar">*</sup></label>
		  	<input placeholder="{{ __('adminstaticword.APPURL') }}" name="APP_URL" type="text" class="{{ $errors->has('APP_URL') ? ' is-invalid' : '' }} form-control" value="{{ $env_files['APP_URL'] }}" >
		...
		<div class="col-md-6">
            ...
            <input value="{{ $setting->default_phone }}" name="default_phone" placeholder="{{ __('adminstaticword.Contact') }}" type="text" class="{{ $errors->has('default_phone') ? ' is-invalid' : '' }} form-control" required>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-6">
            ...
            <input value="{{ $setting->cpy_txt }}" name="cpy_txt" placeholder="{{ __('adminstaticword.CopyrightText') }}" type="text" required class="{{ $errors->has('cpy_txt') ? ' is-invalid' : '' }} form-control">
		</div>
		<div class="col-md-6">
			<label for="wel_email">{{ __('adminstaticword.Email') }}:<sup class="redstar">*</sup></label>
            <input value="{{ $setting->wel_email }}" name="wel_email" placeholder="{{ __('adminstaticword.Email') }}" type="text" class="{{ $errors->has('wel_email') ? ' is-invalid' : '' }} form-control" required>
		</div>
	</div>
	<br>
	...
	{{--<div class="row" style="{{ $setting['map_enable'] == 'map' ? '' : 'display:none' }}" id="sec1_one">--}}
		{{--<div class="col-md-4">--}}
            ...
            {{--<input value="{{ $setting->map_lat }}" name="map_lat" placeholder="{{ __('adminstaticword.MapLatitude') }}" type="text" class="{{ $errors->has('map_lat') ? ' is-invalid' : '' }} form-control">--}}
		{{--</div>--}}
		{{--<div class="col-md-4">--}}
			{{--<label for="map_long">{{ __('adminstaticword.MapLongitude') }}:</label>--}}
            {{--<input value="{{ $setting->map_long }}" name="map_long" placeholder="{{ __('adminstaticword.MapLongitude') }}" type="text" class="{{ $errors->has('map_long') ? ' is-invalid' : '' }} form-control">--}}
		{{--</div>--}}
		{{--<div class="col-md-4">--}}
			{{--<label for="map_api">{{ __('adminstaticword.MapApiKey') }}:</label>--}}
            {{--<input value="{{ $setting->map_api }}" name="map_api" placeholder="{{ __('adminstaticword.MapApiKey') }}" type="text" class="{{ $errors->has('map_api') ? ' is-invalid' : '' }} form-control">--}}
		{{--</div>--}}
	{{--</div>--}}
	...
	{{--<div class="row" style="{{ $setting['promo_enable'] == 1 ? '' : 'display:none' }}" id="sec2_one">--}}
		{{--<div class="col-md-6">--}}
            ...
            {{--<input value="{{ $setting->promo_text }}" name="promo_text" placeholder="{{ __('adminstaticword.PromoText') }}" type="text" class="{{ $errors->has('promo_text') ? ' is-invalid' : '' }} form-control">--}}
		{{--</div>--}}
		{{--<div class="col-md-6">--}}
			{{--<label for="promo_link">{{ __('adminstaticword.PromoLink') }}:</label>--}}
            {{--<input value="{{ $setting->promo_link }}" name="promo_link" placeholder="{{ __('adminstaticword.PromoLink') }}" type="text" class="{{ $errors->has('promo_link') ? ' is-invalid' : '' }} form-control">--}}
		{{--</div>--}}
	{{--</div>--}}
	{{--<hr>--}}
	...
	<div class="row">
		<div class="col-md-6">
            ...
            <textarea name="default_address" rows="3" class="form-control" placeholder="{{ __('adminstaticword.Address') }}" required>{{ $setting->default_address }}</textarea>
		</div>
		<div class="col-md-6">
			<br>
			<div class="row">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div>
	            <small>{{ __('dashboard.setting_text_1') }}<br> {{ __('dashboard.setting_text_2') }}</small>
    ...
    <div class="row">
    	...
    	<div class="col-md-3">
	    	<label for="">{{ __('dashboard.big_blue').' '.__('dashboard.meetings') }}: </label>
			<li class="tg-list-item">
	        ...
	        <div>
	            <small>{{ __('dashboard.setting_text_3') }}</small>
			</div>
    	</div>
