		...
		<div class="panel panel-primary">
		  	...
		  	<div class="panel-body">
		  		<form action="{{ route('sl.fb') }}" method="POST">
			  		...
			  		<input type="text" placeholder="{{ __('adminstaticword.ClientID') }}" class="form-control" name="FACEBOOK_CLIENT_ID" value="{{ $env_files['FACEBOOK_CLIENT_ID'] }}" >
			  		<br>
			  		...
			  		<div class="row">
			  			<div class="eyeCy col-md-12">
			  				...
			  				<input type="password" placeholder="{{ __('adminstaticword.ClientSecretKey') }}" class="form-control" id="fb_secret" name="FACEBOOK_CLIENT_SECRET" value="{{ $env_files['FACEBOOK_CLIENT_SECRET'] }}" >
					...
					<br>
			  		...
			  		<small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('dashboard.use_callback_url') }} <b>{{ url('auth/facebook/callback') }}</b></small>
			  		<br>
			  		<br>
		...
		<div class="panel panel-danger">
			...
			<div class="panel-body">
			  	<form action="{{ route('sl.gl') }}" method="POST">
			  		...
			  		<label for="">{{ __('adminstaticword.ClientID') }}:</label>
			  		<input name="GOOGLE_CLIENT_ID" type="text" placeholder="{{ __('adminstaticword.ClientID') }}" class="form-control" value="{{ $env_files['GOOGLE_CLIENT_ID'] }}">
			  		<br>

			  		<div class="row">
			  			<div class="eyeCy col-md-12">
			  				<label for="">{{ __('adminstaticword.ClientSecretKey') }}:</label>
			  				<input type="password" name="GOOGLE_CLIENT_SECRET" value="{{ $env_files['GOOGLE_CLIENT_SECRET'] }}" placeholder="{{ __('adminstaticword.ClientSecretKey') }}" class="form-control" id="gsecret">
					...
					<br>
			  		...
			  		<small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('dashboard.use_callback_url') }} <b>{{ url('auth/google/callback') }}</b></small>
			  		<br>
			  		<br>
