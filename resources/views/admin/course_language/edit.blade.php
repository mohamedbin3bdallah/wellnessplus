...
@section('title', __('adminstaticword.Edit').' '.__('adminstaticword.CourseLanguage'))
@section('body')
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <input type="text" class="form-control" name="name" value="{{ $language->name }}" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Name') }}">
              </div>
