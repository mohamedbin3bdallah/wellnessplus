...
@section('title', __('adminstaticword.CourseLanguage'))
@section('body')
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.CourseLanguage') }}</h4>
            </div>
            <div class="box box-primary">
                  ...
                  <form id="demo-form2" method="post" action="{{ route('courselang.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Name') }}" value="">
                      </div>
                      <div class="col-md-6">
