...
@section('title', __('adminstaticword.GetStarted'))
@section('body')
	          		...
	          		<form action="{{ action('GetstartedController@update') }}" method="POST" enctype="multipart/form-data">
		                ...
		                {{ method_field('PUT') }}
		                  ...
		                  <div class="col-md-6">
		                    ...
		                    <input value="{{ $show['heading'] }}" autofocus name="heading" type="text" class="form-control" placeholder="{{ __('adminstaticword.Heading') }}"/>
		                  </div>
		                  <div class="col-md-6">
		                    <label for="sub_heading">{{ __('adminstaticword.SubHeading') }}</label>
		                    <input value="{{ $show['sub_heading'] }}" autofocus name="sub_heading" type="text" class="form-control" placeholder="{{ __('adminstaticword.SubHeading') }}"/>
		                  </div>
		              	</div>
		              	<br>
		                  ...
		                  <div class="col-md-6">
		                    ...
		                    <input value="{{ $show['button_txt'] }}" autofocus name="button_txt" type="text" class="form-control" placeholder="{{ __('adminstaticword.ButtonText') }}"/>
		                  </div>
