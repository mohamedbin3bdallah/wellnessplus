...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.FAQ'))
@section('body')
            ...
            <form id="demo-form2" method="post" action="{{url('faqinstructor/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea name="details" class="form-control" rows="5" placeholder="{{ __('adminstaticword.Detail') }}" value=""></textarea>
                </div>
              </div>
              <br>
