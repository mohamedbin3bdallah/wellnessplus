...
@section('title',__('adminstaticword.PlayerSettings'))
@section('body')
          ...
          <div class="box box-primary">
              ...
              <div class="panel-body">
                <form action="{{ route('player.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="exampleInputDetails">{{ __('adminstaticword.PlayerLogo') }}</label>- <p class="inline info">{{ __('dashboard.dimension_ints', ['int1'=>104, 'int2'=>36]) }}</p>
                        <br>  
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputDetails">{{ __('dashboard.video_downlaod_enable') }}:</label>
                            <li class="tg-list-item">              
