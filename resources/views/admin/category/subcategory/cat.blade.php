        ...
        <form action="{{ route('cat.store') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input required placeholder="{{ __('adminstaticword.Name') }}" type="text" class="form-control" name="category">
            </div>
            <div class="col-md-6">
              <label for="icon">{{ __('adminstaticword.Icon') }}:<sup class="redstar">*</sup></label>
              <input type="text" class="form-control icp-auto icp" name="icon" required placeholder="{{ __('adminstaticword.Icon') }}">
            </div>
