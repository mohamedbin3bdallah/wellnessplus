            ...
            <form id="demo-form2" method="post" action="{{url('subcategory/')}}" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="title" id="exampleInputTitle" placeholder="{{ __('adminstaticword.Name') }}" value="">
                </div>
                <div class="col-md-6">
                  <label for="exampleInputTit1e">{{ __('adminstaticword.Icon') }}:<sup class="redstar">*</sup></label>
                  <input type="text" class="form-control icp-auto icp" name="icon" id="exampleInputTitle" placeholder="{{ __('adminstaticword.Icon') }}" value="">
                </div>
              </div>
              <br>
              ...
              <div class="row">
			    <div class="col-md-6">
                  <label for="tags">{{ __('adminstaticword.tags') }}:</label>
                  <textarea class="form-control" name="tags" id="tags" placeholder="{{ __('adminstaticword.tags_with_comma_in_between') }}"></textarea>
                </div>
                <div class="col-md-6">
