    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">{{ __('dashboard.word_translation', ['param1'=>'Backend', 'param2'=>'']).' '.__('dashboard.of') }}  {{ $findlang->name }} ({{ $findlang->local }})</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
        
          <form action="{{ route('update.trans.lang',['backend', $findlang->local]) }}" method="POST">
            @csrf
