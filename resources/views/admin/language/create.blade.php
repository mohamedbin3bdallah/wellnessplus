...
@section('body')
@section("title", __('adminstaticword.Add').' '.__('adminstaticword.Language'))
          ...
          <form id="demo-form2" method="post" action="{{action('LanguageController@store')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <input class="form-control" type="text" name="local" placeholder="{{ __('adminstaticword.Local') }}" required>
                </div>
                <div class="col-md-5">
