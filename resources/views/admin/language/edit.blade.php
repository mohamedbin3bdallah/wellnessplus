...
@section('body')
@section("title",__('adminstaticword.Edit').' '.__('adminstaticword.Language'))
	            ...
	            <form id="demo-form2" method="post" action="{{route('languages.update',$language->id)}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
	              ...
	              <div class="row">
	                <div class="col-md-5">
	                  ...
	                  <input class="form-control" type="text" name="local" value="{{ $language->local }}" placeholder="{{ __('adminstaticword.Local') }}" required>
	                </div>
	                <div class="col-md-5">
	                  <label for="name">{{ __('adminstaticword.Name') }}:<sup class="redstar">*</sup></label>
	                  <input type="text" class="form-control" name="name" value="{{ $language->name }}" id="sub_heading" placeholder="{{ __('adminstaticword.Name') }}" required>
	                </div>
	                <div class="col-md-2">
