...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.BundleCourse'))
@section('body')
            ...
            <form action="{{url('bundle/')}}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }} 
                ...
                <input type="hidden" class="form-control" name="user_id" id="exampleInputTitle" value="{{ Auth::User()->id }}" required>
                  ...
                  <input type="title" class="form-control" name="title" id="exampleInputTitle" placeholder="{{ __('adminstaticword.Title') }}" value="" required>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea id="editor2" name="detail" rows="5"  class="form-control" placeholder="{{ __('adminstaticword.Detail') }}" required ></textarea>
                </div>
              </div>
              <br>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="display-none" id="pricebox">
                    ...
                    <input type="text" class="form-control" name="price" id="priceMain" placeholder="{{ __('adminstaticword.Price') }}" value="">
        
                    <label for="exampleInputSlug">{{ __('adminstaticword.DiscountPrice') }}: </label>
                    <input type="text" class="form-control" name="discount_price" id="offerPrice" placeholder="{{ __('adminstaticword.DiscountPrice') }}" value="">
                  </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  <label>{{ __('adminstaticword.PreviewImage') }}:</label> - <p class="inline info">{{ __('dashboard.size_num', ['num1'=>250, 'num2'=>150]) }}</p>
