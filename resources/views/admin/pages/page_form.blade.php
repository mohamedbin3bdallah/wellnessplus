...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.Pages'))
@section('body')
@if ($errors->any())
            ...
            <form id="demo-form2" method="post" action="{{url('page/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text"  class="form-control" name="title" placeholder="{{ __('adminstaticword.Title') }}"  id="exampleInputTitle" value="">
                </div>
                <div class="col-md-6">                 
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea name="details" id="editor2" rows="5" class="form-control" placeholder="{{ __('adminstaticword.Detail') }}"></textarea>
                  <br>
                </div>
