...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.Slider'))
@section('body')
            ...
            <form id="demo-form2" method="post" action="{{url('slider/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input class="form-control" type="text" name="heading" placeholder="{{ __('adminstaticword.Heading') }}">
                </div>
                <div class="col-md-6">
                  <label for="exampleInputSlug">{{ __('adminstaticword.SubHeading') }}:<sup class="redstar">*</sup></label>
                  <input type="slug" class="form-control" name="sub_heading" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.SubHeading') }}">
                </div>
              </div>
              <br>
              ...
              <div class="row">
                <div class="col-md-6 display-none">
                  ...
                  <input type="title" class="form-control" name="search_text" id="exampleInputTitle" placeholder="{{ __('adminstaticword.SearchText') }}" value="0">
                </div>
                <div class="col-md-12">
                  <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}:<sup class="redstar">*</sup></label>
                  <textarea name="detail" rows="1" class="form-control" placeholder="{{ __('adminstaticword.Detail') }}"></textarea>
                </div>
              </div>
              <br>
