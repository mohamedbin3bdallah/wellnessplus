...
@section('title', __('adminstaticword.Edit').' '.__('adminstaticword.ReportCourse'))
@section('body')
	          		...
	          		<form action="{{url('user/course/report/'.$show->id)}}" method="POST">
		                ...
		                <div class="row">
		                  ...
		                  <div class="col-md-6">
		                    ...
		                    <input value="{{ $show->email }}" autofocus name="email" type="email" class="form-control" placeholder="{{ __('adminstaticword.Email') }}"/>
		                  </div>
		              	</div>
		              	<br>
