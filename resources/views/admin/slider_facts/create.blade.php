...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.FactsSlider'))
@section('body')
            ...
            <form id="demo-form2" method="post" action="{{action('SliderfactsController@store')}}"vdata-parsley-validate 
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <input class="form-control icp-auto icp" type="text" name="icon" placeholder="{{ __('adminstaticword.Icon') }}">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="sub_heading" id="sub_heading" placeholder="{{ __('adminstaticword.SubHeading') }}">
                </div>
              </div>
              <br>
