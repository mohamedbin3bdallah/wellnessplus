...
@section('title', __('adminstaticword.UpdateBlog'))
@section('body')
	          		...
	          		<form action="{{route('blog.update',$show->id)}}" method="POST" enctype="multipart/form-data">
		                ...
		                <div class="row">
		                    ...
		                    <div class="input-group date">
		                    	...
		                    	<input value="{{ $show->date }}" id="datepicker" autofocus required name="heading" type="text" class="form-control" placeholder="{{ __('adminstaticword.Date') }}"/>
		                    </div>
		                  </div>
		                  <div class="col-md-6">
		                  ...
		                  <div class="col-md-6">
		                    ...
		                    <input value="{{ $show->heading }}" autofocus required name="heading" type="text" class="form-control" placeholder="{{ __('adminstaticword.Heading') }}"/>
		                  </div>
		                  <div class="col-md-6">
		                    <label for="text">{{ __('adminstaticword.ButtonText') }}</label>
		                    <input value="{{ $show->text }}" autofocus name="text" type="text" class="form-control" placeholder="{{ __('adminstaticword.ButtonText') }}"/>
		                  </div>
		              	</div>
		              	<br>
		              	<div class="row">
		                  <div class="col-md-9">
		                    ...
		                    <textarea name="detail" rows="5"  class="form-control" placeholder="{{ __('adminstaticword.Detail') }}">{{ $show->detail }}</textarea>
		                  </div>
		                  <div class="col-md-3">
