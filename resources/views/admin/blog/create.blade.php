...
@section('title', __('adminstaticword.AddBlog'))
@section('body')
          ...
          <form id="demo-form2" method="post" action="{{action('BlogController@store')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group date">
                  ...
                  <input class="form-control" type="text" id="datepicker" name="date" placeholder="{{ __('adminstaticword.Date') }}" required>
                </div>
              </div>
              <div class="col-md-6">
                <label for="heading">{{ __('adminstaticword.Heading') }}:<sup class="redstar">*</sup></label>
                <input class="form-control" type="text" name="heading" placeholder="{{ __('adminstaticword.Heading') }}" required>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="text" id="text" placeholder="{{ __('adminstaticword.ButtonText') }}">
              </div>
               <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <textarea name="detail" rows="5"  class="form-control" placeholder="{{ __('adminstaticword.Detail') }}"></textarea>
              </div>
            </div>
            <br> 
