...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.Testimonial'))
@section('body')
              ...
              <form id="demo-form2" method="post" action="{{url('testimonial/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="client_name" id="exampleInputTitle" placeholder="{{ __('adminstaticword.Name') }}" value="">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}:<sup class="redstar">*</sup></label>
                     <textarea name="details" rows="5"  class="form-control" placeholder="{{ __('adminstaticword.Detail') }}">
                      {{ old('details')}}
                    </textarea>
                    <br>
                  </div>
