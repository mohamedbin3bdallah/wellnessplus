...
@section('title', __('adminstaticword.Add').' '.__('adminstaticword.TrustedSlider'))
@section('body')
              ...
              <form id="demo-form2" method="post" action="{{url('trusted/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <input class="form-control" required type="text" name="url" placeholder="{{ __('adminstaticword.URL') }}">
                  </div>
